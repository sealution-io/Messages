...
use Carbon\Carbon;
use Sealution\Messages\TimeMsg;

class TimeMessage implements ProtoModel
{
    public function __construct(protected readonly TimeMsg $proto)
    {
    }
    ...
    public static function fromData(array $data): static
    {
        ...
        return new static(new TimeMsg($data));
    }
    ...
    public function toProto(): TimeMsg
    {
        return $this->proto;
    }
}
